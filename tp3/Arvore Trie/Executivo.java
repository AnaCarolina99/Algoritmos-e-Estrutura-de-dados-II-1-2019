...
//Metodo chamar o metodo inserir
...
//Metodo para inserir os elementos da Trie
   ...
   //Metodo chamar o metodo pesquisar
   public boolean pesquisar(String s) throws Exception {
      return pesquisar(s, raiz, 0);
   }

//Metodo para pesquisar os elementos da Trie e retornar um boolean
   ...
   //Metodo chamar o metodo mostrar
   public void mostrar(){
      mostrar("", raiz);
   }

//Metodo para mostrar os elementos da Trie
...
//Metodo ajudado por Darlan Francisco
// Metodo para pegar o nome na classe Presidente
// E inserir em uma String e retorna-la com o nome
  public String Name(){
   s = getNome();
   return s;
 }
...
//laco para acessar o arquivo, pegar o nome e inserir na 1 arvore
...
//laco para acessar o arquivo, pegar o nome e inserir na 2 arvore
      ...
      int j = 0;
      boolean nome;
      //Laco para inserir na Arvore Trie e pesquisar se a sigla inserida existe
    for(int i = 0; i<nEntrada3; i++){
      MyIO.setCharset("ISO-8859-1");
      String s = entrada3[i];
      nome = arv1.pesquisar(s);
        if( nome == true){
          MyIO.println("SIM");
        }
        else{
    ...
    Arq.openWrite("591513_arvoreTrie.txt","ISO-8859-1");
    //Printacao das variaveis contidas no arquivo
    Arq.println("591513 \t Tempo:" + com +"s \t Comparacoes:" +arv1.comp());
