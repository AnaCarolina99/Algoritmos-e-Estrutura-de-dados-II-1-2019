...
class Fila {
    ...
    public Presidente remover() throws Exception {
      ...
      tmp = null;
        ...
        /*
         *Metodo que mede todas as media do atributo idade
         *e retorna ela arredondada
        */
        public double mediaSomatorio(){
          double resp=0,soma=0,cont = 0;
          Celula i = primeiro.prox;
            while(i!=null){
              soma += i.elemento.getIdade();
              cont++;
              i = i.prox;
            }
            return resp = Math.round(soma/(int)cont);
        }//Fim Metodo

        /*
         *Metodo que chama o metodo mediaSomatorio
         *retorna esse metodo em formato de inteiro
        */
        public int mediaArredondada(){
          int resp = 0;
          return resp = (int) mediaSomatorio();
        }//Fim metodo

        /**
         * Mostra a media dos elementos do atributo idade.
         */
         public void mostrar(){
           MyIO.println(mediaArredondada());
         }

    /* Metodo que percorre a fila inteira
     * Conta o tamanho
     * retorna o tamanho
    */
    public int tamanho(){
...
//laco para acessar o arquivo e inserir no seu final e depois fazer a media
      ...
      //Quando inserida , fazer a sua media
