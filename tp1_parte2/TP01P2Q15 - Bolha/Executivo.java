   ...
   //Retorna a quantidade de Comparacoes
         public int comp(){
           ...
           public int movi(){
             ...
             * Ordena a variavel localNascimento e depois a variavel nome
             */
               public void selecao() {
                 for (int i = 0; i < (n - 1); i++) {
                    int menor = i;
                    for (int j = (i + 1); j < n; j++){
                       if (array[menor].getLocalNascimento() == (array[j].getLocalNascimento())){
...
//laco para ordenar o arquivo
      ...
      Arq.openWrite("591513_bolha.txt","ISO-8859-1");
