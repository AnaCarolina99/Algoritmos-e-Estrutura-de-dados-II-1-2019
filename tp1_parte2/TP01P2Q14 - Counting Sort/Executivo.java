...
class Lista {
   ...
   * Ordena a variavel idade e depois a variavel nome
   */
     public void selecao() {
       for (int i = 0; i < (n - 1); i++) {
          int menor = i;
...
*/
 ...
 //Ordenando
 for(int i = n-1; i >= 0; i--){
      ordenado[count[array[i].getIdade()]-1] = array[i];
      count[array[i].getIdade()]--;
      comp++;
 }
...
//laco para ordenar o arquivo
      ...
      Arq.openWrite("591513_coutingsort.txt","ISO-8859-1");
