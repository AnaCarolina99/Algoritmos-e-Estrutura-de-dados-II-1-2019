...
public static String convertUTF8toISO(String endereco){
   ...
   public static String removeAccents(String str) {
  	str = str.replaceAll("á|à|â|ã|ä","a");
    ...
    * Realiza uma pesquisa sequencial e verifica se a palavra existe no arquivo criado na Classe Docente
    * Retorna um boolean se existe a palavra ou nao inserida
    */
   public boolean pesquisar(String x) {
     MyIO.setCharset("ISO-8859-1");
      boolean retorno = false;
      int j = 0;
      String s = removeAccents(x);
      while(j<n && !retorno){
          if(s.equals(array[j].getNome())){
            retorno = true;
            comparar++;
            System.out.print(array[j].getNome());
          }
          j++;
      }
...
//laco para acessar o arquivo e imprimir seus dados
    ...
    Arq.openWrite("591513_sequencial.txt","ISO-8859-1");
    //Printacao das variaveis contidas no arquivo
    Arq.println("591513 \t Tempo:" + com +"s \t Comparaçoes:" +lista.com());
