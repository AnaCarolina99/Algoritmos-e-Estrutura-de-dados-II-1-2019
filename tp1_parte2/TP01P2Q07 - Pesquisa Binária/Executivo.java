...
//Laco para ler vetor de String ate a "FIM"
      do{
...
//laco para acessar o arquivo e imprimir seus dados
      ...
      //Laco para instanciar Presidente e pesquisar se a String inserida
      //existe no arquivo que criamos na classe Presidente
    for(int i = 0; i<nEntrada2; i++){
      comp+=lista.pesqBinaria(entrada2[i]);
    }//Fim for
        ...
        Arq.println("591513 \t Tempo:" + com +"s \t Comparaçoes:" +comp);
